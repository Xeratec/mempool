...
extern volatile uint32_t ita_state_0;
extern volatile uint32_t ita_start_addr_0;
extern volatile uint32_t ita_eps_mult_L_0;
extern volatile uint32_t ita_eps_mult_H_0;
extern volatile uint32_t ita_right_shift_L_0;
extern volatile uint32_t ita_right_shift_H_0;
extern volatile uint32_t ita_add_L_0;
extern volatile uint32_t ita_add_H_0;
extern volatile uint32_t ita_state_1;
extern volatile uint32_t ita_start_addr_1;
extern volatile uint32_t ita_eps_mult_L_1;
extern volatile uint32_t ita_eps_mult_H_1;
extern volatile uint32_t ita_right_shift_L_1;
extern volatile uint32_t ita_right_shift_H_1;
extern volatile uint32_t ita_add_L_1;
extern volatile uint32_t ita_add_H_1;
extern volatile uint32_t ita_state_2;
extern volatile uint32_t ita_start_addr_2;
extern volatile uint32_t ita_eps_mult_L_2;
extern volatile uint32_t ita_eps_mult_H_2;
extern volatile uint32_t ita_right_shift_L_2;
extern volatile uint32_t ita_right_shift_H_2;
extern volatile uint32_t ita_add_L_2;
extern volatile uint32_t ita_add_H_2;
extern volatile uint32_t ita_state_3;
extern volatile uint32_t ita_start_addr_3;
extern volatile uint32_t ita_eps_mult_L_3;
extern volatile uint32_t ita_eps_mult_H_3;
extern volatile uint32_t ita_right_shift_L_3;
extern volatile uint32_t ita_right_shift_H_3;
extern volatile uint32_t ita_add_L_3;
extern volatile uint32_t ita_add_H_3;
