...
#ifndef __DEEPLOY_MATH_BUILTINS_HEADER_
#define __DEEPLOY_MATH_BUILTINS_HEADER_

#if defined(__XPULPV2) || defined(__XGAP8)
...
#endif //defined(__XPULPV2) || defined(__XGAP8)

#if defined(__XGAP8) && defined(ARCHI_CORE_HAS_CPLX)
...
#endif //defined(__XGAP8) && defined(ARCHI_CORE_HAS_CPLX)

#if defined(__XPULPIMG) || defined(__XPULPV2) || defined(__XGAP8)
...
#endif //defined(__XPULPIMG) || defined(__XPULPV2) || defined(__XGAP8)

#endif //__DEEPLOY_MATH_BUILTINS_HEADER_
